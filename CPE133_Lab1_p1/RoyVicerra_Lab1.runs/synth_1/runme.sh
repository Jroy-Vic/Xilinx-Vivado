...
HD_PWD='C:/Users/vicer/RoyVicerra_Lab1/RoyVicerra_Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Problem1_Schematic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Problem1_Schematic.tcl
