...
HD_PWD='C:/Users/vicer/EE 133_Lab1_Problem3/EE 133_Lab1_Problem3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab1_Problem3_TruthTables.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab1_Problem3_TruthTables.tcl
