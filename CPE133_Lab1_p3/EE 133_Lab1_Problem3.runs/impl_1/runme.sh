...
HD_PWD='C:/Users/vicer/EE 133_Lab1_Problem3/EE 133_Lab1_Problem3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab1_Problem3_TruthTables.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab1_Problem3_TruthTables.tcl -notrace
