...
HD_PWD='C:/Users/vicer/Lab9/Lab9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log L9P2_Sequencer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source L9P2_Sequencer.tcl
