...
HD_PWD='C:/Users/vicer/Lab4/Lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log L4P3_RCA5out.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source L4P3_RCA5out.tcl
