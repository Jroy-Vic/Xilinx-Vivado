...
HD_PWD='C:/Users/vicer/Lab4/Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log L4P3_RCA5out.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source L4P3_RCA5out.tcl -notrace
