...
HD_PWD='C:/Users/vicer/Lab7/Lab7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log L7P4_FF.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source L7P4_FF.tcl -notrace
