...
HD_PWD='C:/Users/vicer/EE 133 - Lab 1 - Problem 2/EE 133 - Lab 1 - Problem 2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab1_Problem2_Equations.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab1_Problem2_Equations.tcl
