...
HD_PWD='C:/Users/vicer/Lab3_Problem1_Buses/Lab3_Problem1_Buses.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log L3P1_Buses.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source L3P1_Buses.tcl -notrace
