...
HD_PWD='C:/Users/vicer/Lab3_Problem1_Buses/Lab3_Problem1_Buses.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log L3P1_Buses.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source L3P1_Buses.tcl
