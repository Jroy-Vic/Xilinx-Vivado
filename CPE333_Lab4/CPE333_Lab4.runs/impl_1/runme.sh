...
HD_PWD='C:/Users/vicer/Vivado Projects/CPE333_Lab4/CPE333_Lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OTTER_MCU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OTTER_MCU.tcl -notrace
