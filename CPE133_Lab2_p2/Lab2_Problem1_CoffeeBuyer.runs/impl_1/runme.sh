...
HD_PWD='C:/Users/vicer/Lab2_Problem1_CoffeeBuyer/Lab2_Problem1_CoffeeBuyer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_Problem1_CoffeeBuyer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab2_Problem1_CoffeeBuyer.tcl -notrace
