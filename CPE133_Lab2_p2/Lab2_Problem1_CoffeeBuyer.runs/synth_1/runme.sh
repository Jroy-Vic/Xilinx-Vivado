...
HD_PWD='C:/Users/vicer/Lab2_Problem1_CoffeeBuyer/Lab2_Problem1_CoffeeBuyer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_Problem1_CoffeeBuyer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab2_Problem1_CoffeeBuyer.tcl
