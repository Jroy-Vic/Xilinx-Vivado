...
HD_PWD='C:/Users/vicer/Lab3_Problem2/Lab3_Problem2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log L3P2_MUX_Circuit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source L3P2_MUX_Circuit.tcl
