...
HD_PWD='C:/Users/vicer/Lab3_Problem2/Lab3_Problem2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log L3P2_MUX_Circuit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source L3P2_MUX_Circuit.tcl -notrace
