...
HD_PWD='C:/Users/vicer/EE133_Lab2/EE133_Lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_Problem2_JudgePanel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab2_Problem2_JudgePanel.tcl
