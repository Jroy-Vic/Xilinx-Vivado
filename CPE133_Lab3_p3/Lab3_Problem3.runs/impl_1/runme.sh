...
HD_PWD='C:/Users/vicer/Lab3_Problem3/Lab3_Problem3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log L3P3_Comparator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source L3P3_Comparator.tcl -notrace
