...
HD_PWD='C:/Users/vicer/Lab3_Problem3/Lab3_Problem3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log L3P3_Comparator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source L3P3_Comparator.tcl
